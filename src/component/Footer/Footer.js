            ...
            <div className="container text-center text-md-left">
                <div className="row text-center text-md-left">
                    ...
                    <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <p>
                            <a href="https://www.google.com" className="text-white" style={{textDecoration:'none'}}>Notice </a>
                        </p>
                        <p>
                            <a href="https://www.google.com" className="text-white" style={{textDecoration:'none'}}>Necessary Documents</a>
                        </p>
                    </div>
                    <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <p>
                             <i className="fas fa-envelope mr-3"> office@moinatravels.com</i>
                        </p>
                        <p>
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-7 col-lg-8">
                            <p>Copyright ©2021 All rights reserved by :  
                                <a href="https://www.google.com" style={{textDecoration:'none'}} ><strong className="text-warning"> Moina Travel Agency</strong> </a> </p>
                        </div>
